...
10. ずらしで一度受けた比喩（飛ぶ、席）を、後半で別の意味のまま再利用しない。使うならその場で言い換える。

2026-08-28「設計の席」草稿で止まった語と直し:

| 出していた語 | 読者に届かなかった意味 | 本文の言い換え |
|---|---|---|
...
| 三相＝Woodの一時性 | 素材を論文定義へ置換 | 三相は足場を明示し判断が見えたら緩める。Wood そのものではない |
...
文面はカード用の要約ではなく、タイムラインで読める短文にする。1文は1つの動き（願い → ずらし → 残す線）。であるの畳みかけや、description のほぼ全文貼りは避ける。
